...
set_up_commands(bot)
bot.setWebhook(url='https://5ac1-92-245-116-36.in.ngrok.io/telegram-bot/cleaning-serice-bot/update/')  # вставить в url https:// Ngrok или путь с протоколом https + telegram-bot/cleaning-serice-bot/update/
