...
from tgbot.handlers.orders.order_staff_callback import (order_staff_accept_callback,
                                                        order_staff_refuse_callback,
                                                        refuse_true_callback,
                                                        refuse_false_callback,
                                                        in_place_callback,
                                                        work_start_callback,
                                                        work_end_callback,
                                                        order_information_update,
                                                        order_information)
