...
set_up_commands(bot)
# bot.setWebhook(url='https://a8f3-212-112-118-101.in.ngrok.io/telegram-bot/cleaning-serice-bot/update/')  # вставить в url https:// Ngrok или путь с протоколом https + telegram-bot/cleaning-serice-bot/update/
