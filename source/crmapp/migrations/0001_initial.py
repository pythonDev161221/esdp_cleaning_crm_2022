# Generated by Django 4.0.4 on 2022-05-01 22:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_start', models.DateTimeField(blank=True, null=True, verbose_name='Дата и время выполнения уборки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='photo_before/', verbose_name='Фото')),
                ('photo_after', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='image_after', to='crmapp.foremanreport', verbose_name='Фото после окончания работ')),
                ('photo_before', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='image_before', to='crmapp.foremanreport', verbose_name='Фото до начала работ')),
            ],
        ),
        migrations.CreateModel(
