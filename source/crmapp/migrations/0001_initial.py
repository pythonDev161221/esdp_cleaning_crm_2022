# Generated by Django 4.0.5 on 2022-06-12 16:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(blank=True, choices=[('new', 'Новый'), ('in_queue', 'В очереди'), ('in_progres', 'Выполняется'), ('done', 'Выполнен'), ('disputable', 'Спорный'), ('to_fix', 'Переделывается'), ('finished', 'Завершен')], default='new', max_length=50, null=True, verbose_name='Статус заказа')),
