    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('Piece', 'штука'), ('Liter', 'литр'), ('kg', 'килограмм')], default='Piece', max_length=126, verbose_name='Единица измерения')),
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ManyToManyField(related_name='foreman_service', to='crmapp.service', verbose_name='Услуга'),
        ),
        migrations.CreateModel(
            name='Fine',
            fields=[
