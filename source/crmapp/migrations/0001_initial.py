    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_inventory', to='crmapp.inventory', verbose_name='Инвентарь заказа')),
                ...
                ('soap_washer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_cleansear', to='crmapp.cleansear', verbose_name='Мыломойка заказа')),
            ],
        ),
        migrations.CreateModel(
            name='ForemanReport',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('extra_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='foreman_extra', to='crmapp.extraserviceorder', verbose_name='Дополнительная услуга')),
        ...
        migrations.AddField(
            ...
            name='extra_service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='extra_services_service', to='crmapp.service', verbose_name='Доп. услуга'),
        ),
    ]
