    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus', models.CharField(max_length=300, verbose_name='Бонус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(blank=True, choices=[('new', 'Новый'), ('to_fix', 'Переделывается'), ('finished', 'Завершен'), ('canceled', 'Отменен')], default='new', max_length=50, null=True, verbose_name='Статус заказа')),
                ...
                ('cleaning_time', models.TimeField(blank=True, null=True, verbose_name='Время выполнения работ')),
                ...
                ('cleaners_part', models.PositiveIntegerField(blank=True, null=True, verbose_name='Доля клинеров')),
                ('part_units', models.CharField(choices=[('som', 'В сомах'), ('percent', 'В процентах')], default='som', max_length=25, verbose_name='Способ расчета')),
                ('description', models.TextField(max_length=2000, null=True, verbose_name='Примечание')),
            ...
            options={
                ...
                'db_table': 'order',
                'permissions': [('сan_view_income_outcome_report', 'Может просмотреть отчет о расходах и доходах'), ('can_view_order_deleted_list', 'Может просмотреть список удаленных заказов')],
            },
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_start', models.DateTimeField(blank=True, null=True, verbose_name='Начало работ')),
                ('work_end', models.DateTimeField(blank=True, null=True, verbose_name='Конец работ')),
            ...
            options={
                'verbose_name': 'Сотрудник в заказе',
                'verbose_name_plural': 'Сотрудники в заказе',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Объем работы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foreman_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foreman_photo', to='crmapp.stafforder', verbose_name='Фото до начала работ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Сумма расхода')),
                ('description', models.TextField(blank=True, max_length=1000, null=True, verbose_name='Описание расхода')),
                ('foreman_report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='foreman_expense', to='crmapp.stafforder', verbose_name='Отчёт бригадира')),
            ],
            options={
                'verbose_name': 'Расход бригадира',
                'verbose_name_plural': 'Расходы бригадира',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_manager_cash', to='crmapp.order', verbose_name='Заказ')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='manager_cash', to=settings.AUTH_USER_MODEL, verbose_name='Менеджер')),
            ],
            options={
                'verbose_name': 'Касса менеджера',
                'verbose_name_plural': 'Касса менеджеров',
